...
<div class="layui-container">
    ...
    <div class="layui-row layui-col-space20" style="padding: 10px; height: 95%">
        ...
        <div class="layui-col-md7">
            ...
            <fieldset class="layui-elem-field layui-field-title">
                <legend>
                    <span class="layui-breadcrumb">
                        ...
                        <a href="<%=request.getContextPath()%>/article/index.do">素材专区</a>
            ...
            <hr>
            <form class="layui-form"  method="post" id="form-article-search" action="<%=request.getContextPath()%>/article/search.do">
