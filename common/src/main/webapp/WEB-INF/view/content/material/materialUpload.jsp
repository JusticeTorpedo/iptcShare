...
<head>
    <meta charset="utf-8">
    <title>${username}的个人中心-发布素材</title>
    ...
    <script>
        layui.use(['element','form','layedit'],function () {
            ...
            layedit.set({
                uploadImage: {
                    url: '<%=request.getContextPath()%>/material/image/upload.do',
                    type: 'post'
                }
            });
            ...
            //构建一个默认的编辑器
            var index = layedit.build('material-content',{
                height:400
            });
        });
    </script>
            ...
            <div class="layui-row layui-col-space15">
                <div class="layui-col-md12">
                    <div class="layui-panel" style="padding: 30px 30px 50px;">
                        ...
                        <form class="layui-form"  method="post" id="form-article-insert" action="<%=request.getContextPath()%>/material/upload.do">
                            ...
                            <div class="layui-form-item">
                                <label class="layui-form-label">素材标题 <span style="color: #FF5722; ">*</span></label>
                                <div class="layui-input-block">
                                    <input type="text" name="materialTitle" autocomplete="off" placeholder="请输入标题" class="layui-input" required>
                                </div>
                            </div>

                            <div class="layui-form-item layui-form-text">
                                <label class="layui-form-label">素材内容 <span style="color: #FF5722; ">*</span></label>
                                <div class="layui-input-block">
                                    <textarea class="layui-textarea layui-hide" name="materialContent" id="material-content"></textarea>
                                </div>
                            </div>

                            <div class="layui-form-item">
                                <div class="layui-input-block">
                                    <button class="layui-btn" lay-submit="">发布素材</button>
